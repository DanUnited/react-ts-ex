...
export const VDotsIcon = (props: ISVGElement) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="#68717B" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_1713_15365)">
      <path
      ...
      />
      <path
        d="M10.0002 11.6673C10.9206 11.6673 11.6668 10.9211 11.6668 10.0006C11.6668 9.08017 10.9206 8.33398 10.0002 8.33398C9.07969 8.33398 8.3335 9.08017 8.3335 10.0006C8.3335 10.9211 9.07969 11.6673 10.0002 11.6673Z"
      />
      <path
